...
# England uses British Summer Time (BST = UTC+1) during the World Cup (late March to late October).
england_tz = timezone(timedelta(hours=1))
now = datetime.now(england_tz)
